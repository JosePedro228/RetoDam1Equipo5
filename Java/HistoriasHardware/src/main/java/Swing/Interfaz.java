...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        getContentPane().add(marco, java.awt.BorderLayout.CENTER);
    ...
    private void completoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_completoButtonActionPerformed
        // TODO add your handling code here:
        NombreIdentificativoTabla.setText("Completo");
        DefaultTableModel tabla = (DefaultTableModel) tablaInformes.getModel();
...
//        cargarInventario(tablaPrestamo, inventario);
    ...
    private void importarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importarButtonActionPerformed
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            String ruta = chooser.getSelectedFile().getAbsolutePath();
            InformeDAO.importarElementosCSV(con, ruta);
            JOptionPane.showMessageDialog(this, "Ubicaciones importadas correctamente.");
        }
